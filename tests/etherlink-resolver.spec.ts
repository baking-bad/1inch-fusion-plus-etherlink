...
const mockApiResponse = {
    params: {
        amountIn: '1000000',
        amountOutMin: '990000',
        to: '0xd83f2583568aa36d3c1d10022c4edbc4cc049685',
        deadline: '1753915666',
        params: '131584',
        tokens: [
            {tokenAddress: getToken(dstChainId, 'USDC').address, isNative: false},
            {tokenAddress: getToken(dstChainId, 'WBTC').address, isNative: false}
        ],
        steps: [{routerAddress: '0xb1ea698633d57705e93b0e40c1077d46cd6a51d8', packedData: '281642749001728'}],
        referrerInfo: {referrer: '0x0000000000000000000000000000000000000000', feeAmount: '0'}
    },
    router: dstChainConfig.etherlinkRouter || '0x693762D959A7f0deF7d54Ae440c935a85a82f6a0',
    dstAmount: '995000',
    gas: 200000
}
...
describe('EtherlinkResolver Tests', () => {
